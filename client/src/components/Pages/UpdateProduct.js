...
export default function AddProduct()  {
  ...
  return (
      <>
        ...
        <div className='UpdateProduct mb-5'>
            <Container>
                
                <Row >
                
                    <Col lg={6} >
                        <h1 className='text-bold text-red mb-5' >Update Product</h1>
                        <Form >
                            <Form.Group>
                                    <Form.Control
                                        name="title"
                                    ...
                                    <Form.Label htmlFor='input-file' className='red-opacity  p-2 mb-5 rounded w-100 form-file '>
                                        ...
                                        <Row className='justify-content-center'>
                                            <Col lg={10}>
                                                <Button onClick={handleSubmit} className="btn-red bg-red mb-3 w-100" variant='light' >Update Product</Button>
                                            </Col>
                                        </Row>
